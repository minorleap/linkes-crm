...
urlpatterns = [
    ...
    path('groupsession/<int:pk>/addchild', views.add_group_session_attender, name='add_group_session_attender'),
    path('groupsession/<int:pk>/removechild', views.remove_group_session_attender, name='remove_group_session_attender'),
