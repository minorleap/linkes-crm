...
def group_type_list(request):
    ...
    return render(request, 'childrensgroup/grouptype/list.html', {'group_types': group_types, 'groups': groups})


@login_required
def group_type_detail(request, pk):
    group_type = get_object_or_404(GroupType, pk=pk)
    return render(request, 'childrensgroup/grouptype/detail.html', {'group_type': group_type})
...
def edit_group_type(request, pk):
    ...
    return render(request, 'childrensgroup/grouptype/edit.html', {'group_type_form': group_type_form, 'group_type': group_type})
...
def create_group_type(request):
    ...
    return render(request, 'childrensgroup/grouptype/edit.html', {'new_group_type': new_group_type, 'group_type_form': group_type_form})
...
def group_detail(request, pk):
    ...
    bookers = [booking.child for booking in bookings]
    return render(request, 'childrensgroup/group/detail.html',
        {
            'group': group,
            'sessions': sessions,
            'bookings': bookings,
...
def create_group(request):
    ...
    return render(request, 'childrensgroup/group/edit.html', {'new_group': new_group, 'group_form': group_form, 'group_type': group_type, 'action': 'create'})
...
def edit_group(request, pk):
    ...
    return render(request, 'childrensgroup/group/edit.html', {'group_form': group_form, 'group_type': group_type, 'group': group, 'action': 'edit'})
...
def group_session_list(request):
    ...
    return render(request, 'childrensgroup/groupsession/list.html', {'group_sessions_filter': group_sessions_filter})
...
def group_session_detail(request, pk):
    ...
    bookers = [booking.child for booking in group_session.group.bookings.all()]
    return render(request, 'childrensgroup/groupsession/detail.html',
        {
...
def create_group_session(request):
    ...
    return render(request, 'childrensgroup/groupsession/edit.html', {'new_group_session': new_group_session, 'group_session_form': group_session_form, 'group': group})
...
def create_bulk_group_sessions(request):
    ...
    initial = {'group': group, 'start_date': start, 'end_date': end}
    if request.method == 'POST':
    ...
    return render(request, 'childrensgroup/groupsession/bulk-edit.html', {'bulk_group_session_form': bulk_group_session_form, 'group': group})
...
def edit_group_session(request, pk):
    ...
    return render(request, 'childrensgroup/groupsession/edit.html', {'group_session_form': group_session_form, 'group_session': group_session, 'group': group})
...
def add_group_session_attender(request, pk):
    ...
    group_session.attenders.add(child)
...
def remove_group_session_attender(request, pk):
    ...
    child_id = request.GET.get('child')
    child = get_object_or_404(Child, pk=child_id)
    group_session.attenders.remove(child)
    return redirect(group_session.get_absolute_url())
...
def create_group_booking(request):
    ...
    if request.method == 'POST':
        ...
        if group_booking_form.is_valid():
            ...
            return redirect(child.get_absolute_url() + '#groups')
    else:
        group_booking_form = GroupBookingForm(initial=initial)
    return render(request, 'childrensgroup/groupbooking/edit.html', {'new_group_booking': new_group_booking, 'group_booking_form': group_booking_form, 'child': child, 'referrer': 'child'})
...
def edit_group_booking(request, pk):
    ...
    return render(request, 'childrensgroup/groupbooking/edit.html', {'group_booking_form': group_booking_form, 'group_booking': group_booking, 'group': group, 'child': child, 'referrer': referrer})
...
def delete_group_booking(request, pk):
    ...
    if referrer == 'child':
        return redirect(group_booking.child.get_absolute_url() + '#groups')
    else:
