...
def group_type_list(request):
    ...
    return render(request, 'group/grouptype/list.html', {'group_types': group_types, 'groups': groups})


@login_required
def group_type_detail(request, pk):
    group_type = get_object_or_404(GroupType, pk=pk)
    return render(request, 'group/grouptype/detail.html', {'group_type': group_type})
...
def edit_group_type(request, pk):
    ...
    return render(request, 'group/grouptype/edit.html', {'group_type_form': group_type_form, 'group_type': group_type})
...
def create_group_type(request):
    ...
    return render(request, 'group/grouptype/edit.html', {'new_group_type': new_group_type, 'group_type_form': group_type_form})
...
def group_detail(request, pk):
    ...
    return render(request, 'group/group/detail.html',
        {
            'group': group,
            'sessions': sessions,
            'bookings': bookings,
...
def create_group(request):
    ...
    return render(request, 'group/group/edit.html', {'new_group': new_group, 'group_form': group_form, 'group_type': group_type, 'action': 'create'})
...
def edit_group(request, pk):
    ...
    return render(request, 'group/group/edit.html', {'group_form': group_form, 'group_type': group_type, 'group': group, 'action': 'edit'})
...
def group_session_list(request):
    ...
    return render(request, 'group/groupsession/list.html', {'group_sessions_filter': group_sessions_filter})
...
def group_session_detail(request, pk):
    ...
    bookers = [booking.client for booking in group_session.group.bookings.all()]
    return render(request, 'group/groupsession/detail.html',
        {
...
def create_group_session(request):
    ...
    return render(request, 'group/groupsession/edit.html', {'new_group_session': new_group_session, 'group_session_form': group_session_form, 'group': group})
...
def create_bulk_group_sessions(request):
    ...
    return render(request, 'group/groupsession/bulk-edit.html', {'bulk_group_session_form': bulk_group_session_form, 'group': group})
...
def edit_group_session(request, pk):
    ...
    return render(request, 'group/groupsession/edit.html', {'group_session_form': group_session_form, 'group_session': group_session, 'group': group})
...
def create_group_booking(request):
    ...
    return render(request, 'group/groupbooking/edit.html', {'new_group_booking': new_group_booking, 'group_booking_form': group_booking_form, 'client': client, 'referrer': 'client'})
...
def edit_group_booking(request, pk):
    ...
    return render(request, 'group/groupbooking/edit.html', {'group_booking_form': group_booking_form, 'group_booking': group_booking, 'group': group, 'client': client, 'referrer': referrer})
...
def delete_group_booking(request, pk):
    ...
    if referrer == 'client':
        return redirect(group_booking.client.get_absolute_url() + '#groups')
    else:
